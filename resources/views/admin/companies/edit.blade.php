...
@section('title', isset($company) ? 'Editar Institución' : 'Editar Compañía')
@section('header', isset($company) ? 'Editar Institución' : 'Editar Compañía')
...
<div class="company-create-modern">
    ...
    <div class="form-hero">
        <div class="hero-content">
            ...
            <div class="hero-text">
                <h1 id="heroTitle">Editar {{ $company->getTypeLabel() }}</h1>
                <p id="heroSubtitle">Actualice la información de {{ $company->name }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div class="section-title">
                        ...
                        <p>Selecciona el tipo de institución</p>
                    </div>
                </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div class="section-title">
                        ...
                        <p>Sube o actualiza el logo de la institución</p>
                    </div>
                </div>
...
<script>
    ...
    function updateTypeFields() {
        ...
        // Mostrar según selección y actualizar título
        if (selectedType === 'company') {
            if (companySpecific) companySpecific.style.display = 'block';
            if (heroTitle) heroTitle.textContent = 'Editar Empresa';
            if (heroSubtitle) heroSubtitle.textContent = `Actualice la información de ${companyName}`;
        } else if (selectedType === 'school') {
            if (schoolSpecific) schoolSpecific.style.display = 'block';
            if (heroTitle) heroTitle.textContent = 'Editar Colegio';
            if (heroSubtitle) heroSubtitle.textContent = `Actualice la información de ${companyName}`;
        } else if (selectedType === 'ngo_rescue') {
            if (ngoRescueSpecific) ngoRescueSpecific.style.display = 'block';
            if (heroTitle) heroTitle.textContent = 'Editar ONG de Rescate';
            if (heroSubtitle) heroSubtitle.textContent = `Actualice la información de ${companyName}`;
        } else if (selectedType === 'government') {
            if (governmentSpecific) governmentSpecific.style.display = 'block';
            if (heroTitle) heroTitle.textContent = 'Editar Organización Gubernamental';
            if (heroSubtitle) heroSubtitle.textContent = `Actualice la información de ${companyName}`;
        }
    ...
    function removeLogo() {
        if (confirm('¿Eliminar el logo actual?')) {
            ...
            // Agregar campo oculto para indicar que se debe eliminar el logo
